...
const stdPersonalSchema = {
    ...
    isPhysicalHandicalHandicapped:{type: Boolean, required: true},
    physicallyHandicapped:{type: String, required: true},  //probably for describing physical handicap, dont think its duplicated without reason
    ...
    motherMobNo:{type: Number, required: true},
    motherEmailId:{type: String, required: true},
